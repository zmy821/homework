...
//
//	mockgen -source=./types.go -package=limitermocks -destination=./mocks/limiter.mocks.go Limiter
//
...
// MockLimiter is a mocks of Limiter interface.
type MockLimiter struct {
	ctrl     *gomock.Controller
	recorder *MockLimiterMockRecorder
}

// MockLimiterMockRecorder is the mocks recorder for MockLimiter.
type MockLimiterMockRecorder struct {
	mock *MockLimiter
}

// NewMockLimiter creates a new mocks instance.
